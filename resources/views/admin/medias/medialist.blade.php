...
@section('content')
  ...
  <div class="row ">
    ...
    <div class="card">
     <div class="card-header" align="center"><i class="icon-user"></i> <i class="icon-list"></i>  MEDIA LIBRARY FOR ADVERTISING </div>
    ...
    <div id="loadingDiv"></div> 
     ...
     <!---------modal end --->
     <a href="{{route('ads.create')}}"><button type="submit" class="btn btn-light" style="float: right;" ><i class="fa fa-backward"></i> BACK TO ADVERTISING CREATE</button></a>
        	  ...
        	  <div class="card-group">
		       <div class="card">
		    	...
		    	<div class="card-body">
					...
					<a href="{{route('avator.select',['id'=>$avator->id])}}">
					  <button type="submit" class="btn-light" ><i class="fa fa-plus"></i>
Add</button>
					</a>
                      <!--------delete start--------------------------->
