...
@section('content')
  ...
  <div class="row ">
     <div class="col-lg-12" ><!--  <div class="col-lg-12 col-xl-12"> -->
        ...
        @endforeach
    <div class="card">
     <div class="card-header" align="center"><i class="icon-user"></i> <i class="icon-list"></i>  ADVERTISING CREATE </div>
     <div class="card-body">
                     ...
                     <div class="col-md-4 pr-md-1">
                       <div class="form-group">
                         <label><i class="fa fa-server"></i> Advertising File (*) </label><br>
                          <a href="{{route('avator.index')}}"><button type="button" class="btn btn-light" ><i class="icon-plus"></i> CHOOSE FILE</button></a>
                       </div>
                     </div> 
                    ...
                    <div class="row">
                     <div class="col-md-12 pr-md-1">
                       <div class="form-group">
                         ...
                         <input type="number" name="display_time" class="form-control">
                    ...
                    <div class="row">
                     <div class="col-md-12 pr-md-1">
                       <div class="form-group">
                         ...
                         <input type="number" name="display_type" class="form-control" min="1" max="2">
